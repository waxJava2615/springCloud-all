...
import com.starry.sky.infrastructure.oauth.extension.captcha.CaptchaTokenGranter;
import com.starry.sky.infrastructure.oauth.support.CustomAccessDeniedHandler;
import com.starry.sky.infrastructure.oauth.userdetails.CustomUserDetailService;
...
//    }
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                .secret(passwordEncoder.encode("adminClient"))
                .scopes("all")
                .redirectUris("https://www.baidu.com")
                .authorizedGrantTypes("authorization_code","password", "refresh_token","custom_admin")
                .and()
                .withClient("vipClint")
                .secret(passwordEncoder.encode("vipClint"))
                .scopes("all")
                .redirectUris("https://www.baidu.com")
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        CaptchaTokenGranter captchaTokenGranter = new CaptchaTokenGranter(endpoints.getTokenServices(), endpoints.getClientDetailsService(),
                endpoints.getOAuth2RequestFactory(), authenticationManager,objectCache);
        granterList.add(captchaTokenGranter);
    ...
    /**
     * 自定义认证异常响应数据 Token异常信息 需要添加到ResourceServerSecurityConfigure
     */
    @Bean
