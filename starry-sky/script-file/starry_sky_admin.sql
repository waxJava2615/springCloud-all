...
CREATE TABLE `sys_admin_menu` (
  ...
  `parent` bigint(20) DEFAULT NULL COMMENT '菜单父ID',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `sys_admin_menu` VALUES ('1', '员工管理', '/sysAdminUser/list.do', null);
INSERT INTO `sys_admin_menu` VALUES ('2', '菜单管理', '/sysAdminMenu/list.do', null);
...
-- ----------------------------
INSERT INTO `sys_admin_operation` VALUES ('1', '查找', '1000', '/select', null);
INSERT INTO `sys_admin_operation` VALUES ('2', '新增', '2000', '/push', null);
INSERT INTO `sys_admin_operation` VALUES ('3', '修改', '3000', '/eidt', null);
INSERT INTO `sys_admin_operation` VALUES ('4', '删除', '4000', '/remove', null);
INSERT INTO `sys_admin_operation` VALUES ('5', '导出', '5000', '/export', null);
...
-- ----------------------------
INSERT INTO `sys_admin_permission` VALUES ('1', 'menu');
...
-- ----------------------------
INSERT INTO `sys_admin_permission_menu_relation` VALUES ('1', '1');
INSERT INTO `sys_admin_permission_menu_relation` VALUES ('1', '2');
...
-- ----------------------------
INSERT INTO `sys_admin_permission_operation_relation` VALUES ('1', '1');
INSERT INTO `sys_admin_permission_operation_relation` VALUES ('1', '2');
INSERT INTO `sys_admin_permission_operation_relation` VALUES ('1', '3');
INSERT INTO `sys_admin_permission_operation_relation` VALUES ('1', '4');
INSERT INTO `sys_admin_permission_operation_relation` VALUES ('1', '5');
...
-- ----------------------------
INSERT INTO `sys_admin_role` VALUES ('1', 'admin');
INSERT INTO `sys_admin_role` VALUES ('2', 'user');
INSERT INTO `sys_admin_role` VALUES ('3', 'default');
...
-- ----------------------------
INSERT INTO `sys_admin_role_permission_relation` VALUES ('1', '1');
INSERT INTO `sys_admin_role_permission_relation` VALUES ('1', '2');
...
-- ----------------------------
INSERT INTO `sys_admin_user_role_relation` VALUES ('1', '1');
