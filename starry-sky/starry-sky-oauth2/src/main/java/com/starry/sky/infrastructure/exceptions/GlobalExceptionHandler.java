...
public class GlobalExceptionHandler {
    ...
    public ResultData handleOauth2(CustomAuthenticationException ex) {
        return ResultData.customizeResult(ex.getCode(),ex.getMessage());
    }
...
//        log.error("unKnowExceptionHandler ",e);
...
//    public ResultData clientRegistrationExceptionHandler(ClientRegistrationException ex) {
//        return ResultData.customizeResult(ex.getMessage());
//    }
//
//    /**
//     * 400错误
...
//        return ResultData.customizeResult(ResultCode.AUTHENTICATION_NOT_USER.getCode(),ResultCode.AUTHENTICATION_NOT_USER.getMessage());
//    }
//
//
//    /**
...
//
    ...
    private ResultData argumentsError() {
        return ResultData.customizeResult(ResultCode.FAIL.getCode(),ResultCode.FAIL.getMessage());
    }
