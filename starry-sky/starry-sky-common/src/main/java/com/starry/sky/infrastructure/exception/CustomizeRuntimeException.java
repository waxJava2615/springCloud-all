...
public class CustomizeRuntimeException extends RuntimeException {
    ...
    public CustomizeRuntimeException(int code) {
        super();
        this.code = code;
    }
    ...
    public CustomizeRuntimeException(String message,int code) {
        super(message);
        this.code = code;
    }
    ...
    public CustomizeRuntimeException(IResultCode resultCode) {
    ...
    public CustomizeRuntimeException(String message, Throwable cause,int code) {
        super(message, cause);
        this.code = code;
    }
    ...
    public CustomizeRuntimeException(Throwable cause,int code) {
        super(cause);
        this.code = code;
    }
     ...
     * @since 1.7
     */
    protected CustomizeRuntimeException(String message, Throwable cause, boolean enableSuppression,
