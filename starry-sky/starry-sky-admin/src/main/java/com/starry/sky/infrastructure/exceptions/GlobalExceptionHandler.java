...
//    }
    ...
    public ResultData notFoundException(HttpServletResponse response) {
        return ResultData.customizeResult(ResultCode.REQUEST_URL_NOT_FOUND);
    }
    ...
    private ResultData serverErrorHandler() {
        return ResultData.customizeResult(ResultCode.REQUEST_SERVER_ERROR);
    }

    private ResultData argumentsError() {
        return ResultData.customizeResult(ResultCode.FAIL);
    }
